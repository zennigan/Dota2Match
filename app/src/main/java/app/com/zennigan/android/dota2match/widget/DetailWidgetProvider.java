...
import app.com.zennigan.android.dota2match.MainActivity;
import app.com.zennigan.android.dota2match.R;
import app.com.zennigan.android.dota2match.data.Dota2MatchProvider;
...
public class DetailWidgetProvider extends AppWidgetProvider {
    ...
    public void onReceive(@NonNull Context context, @NonNull Intent intent) {
        ...
        if (Dota2MatchProvider.ACTION_DATA_UPDATED.equals(intent.getAction())) {
